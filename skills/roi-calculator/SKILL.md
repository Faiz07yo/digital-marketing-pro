...
3. **Run ROI calculator**: Execute `${CLAUDE_PLUGIN_ROOT}/scripts/roi-calculator.py` with spend, revenue, and conversion data to compute channel-level and blended metrics.
